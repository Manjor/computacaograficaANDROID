...
//        spritesCachorro.add(cachorroup);
        ...
        this.telaPause = createSprite(R.mipmap.fogopause, 1, 1);
        this.telaPause.setScreenPercent(90, 80);
        ...
        this.pause = createSprite(R.mipmap.pause, 1, 1);
        this.pause.setScreenPercent(5, 5);
        this.pause.vrPosition.setXY(AGScreenManager.iScreenWidth * 0.95f, AGScreenManager.iScreenHeight * 0.90f);

        this.som = createSprite(R.mipmap.som, 3, 1);
        this.som.setScreenPercent(5, 5);
        this.som.vrPosition.setXY(AGScreenManager.iScreenWidth * 0.85f, AGScreenManager.iScreenHeight * 0.90f);
        this.som.addAnimation(10, false, 0, 1);
        this.som.addAnimation(10, false, 1, 2);

        this.resume = createSprite(R.mipmap.end, 1, 1);
        this.resume.setScreenPercent(10, 10);
        this.resume.vrPosition.setXY(AGScreenManager.iScreenWidth / 2, AGScreenManager.iScreenHeight * 0.70f);
        this.resume.bVisible = false;

        this.sair = createSprite(R.mipmap.exit, 1, 1);
        this.sair.setScreenPercent(10, 10);
        this.sair.vrPosition.setXY(AGScreenManager.iScreenWidth / 2, AGScreenManager.iScreenHeight * 0.55f);
